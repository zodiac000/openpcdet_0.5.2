...
class KittiDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.num_point_features = 4  # TODO: (du) 改为配置文件来配置
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        from .kitti_object_eval_python import eval_v2 as kitti_eval
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        print("Please make sure modify your kitti dataset path in pcdet/datasets/kitti/kitti_dataset.py ! ")
        ROOT_DIR = Path("/data9/duzhe/dataset/opendata/kitti/kitti/")
        create_kitti_infos(
