### updates
- 支持lidar坐标系下数据训练, 参见[lidar_pandaset](./tools/cfgs/lidar_pandaset_models/pointpillar_exp1.yaml)。
支持多数据集联合训练，需要将数据标签类别统一，修改读取时的类别转换即可。(2022-1-21)


### 安装
1. 在3080上安装spconv：`pip install spconv-cu111`
2. 编译本库。`python setup.py develop`
